...
#
# Migrated from mem0 OSS: mem0/configs/prompts.py
# Upstream: https://github.com/mem0ai/mem0
# Commit: 4fa483907704735ba0bec030e3c946ee1614b50e
# Version: 2.0.18
#
# Modifications:
# - Isolated ADD-only extraction prompts (dropped FACT_RETRIEVAL / UPDATE prompts)
# - Namespaced under desaymem.extraction
# - Added vehicle-cockpit optional custom-instruction helper
...
# Optional cockpit-oriented hint. Not injected by default so v1 extraction
# stays aligned with the upstream ADD-only prompt. Callers may pass this as
# custom_instructions when they want vehicle-specific emphasis.
VEHICLE_CUSTOM_INSTRUCTIONS = (
    "Preserve in-vehicle preferences with exact numbers and names: "
    "climate temperature, seat position, navigation destinations, "
    "media, occupant identity, and driving-scene context. "
    "Write memories in the same language as the input messages."
)

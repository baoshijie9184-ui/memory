...
API_BASE_URL = 'http://127.0.0.1:20140/v1'
...
EMBEDDING_MODEL_DIMS = 1024  # bge-m3 output dim

# Data Configuration
DATA_PATH = os.environ.get('LOCOMO_DATA_PATH', '/data/pengshuang/memory-benchmark/data/lightmem/locomo_smoke1.json')
DATASET_TYPE = 'locomo'

# Qdrant Storage Directories
QDRANT_PRE_UPDATE_DIR = '/data/pengshuang/memory-benchmark/data/lightmem/qdrant_pre_update'
QDRANT_POST_UPDATE_DIR = '/data/pengshuang/memory-benchmark/data/lightmem/qdrant_post_update'

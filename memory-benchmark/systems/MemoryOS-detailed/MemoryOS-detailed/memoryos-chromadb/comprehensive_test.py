...
def main():
    ...
    memoryos = Memoryos(
        ...
        openai_api_key='sk-bakuopflqametmrahmluljzoydoqttetzdftpwqlmtvrkaln',
        openai_base_url='https://api.siliconflow.cn/v1',
        data_storage_path='./comprehensive_test_data_api',  # 使用新的数据存储路径
        ...
        use_embedding_api=True  # 启用 API embedding
    )
